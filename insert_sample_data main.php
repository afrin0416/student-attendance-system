...
$conn->query("INSERT IGNORE INTO teachers (teacher_id, username, password, teacher_name, email, department_id) VALUES 
    (1, 'john_doe', '123456', 'Dr. John Doe', 'john@example.com', 1),
    (2, 'jane_smith', '123456', 'Prof. Jane Smith', 'jane@example.com', 1),
    (3, 'mike_wilson', '123456', 'Dr. Mike Wilson', 'mike@example.com', 2)");
...
$conn->query("INSERT IGNORE INTO courses (course_id, course_code, course_name, department_id, teacher_id, semester) VALUES 
    ...
    (3, 'CSE301', 'Database Management', 1, 2, 'Spring 2024'),
    (4, 'EEE101', 'Circuit Theory', 2, 3, 'Spring 2024')");

// Insert Students
$conn->query("INSERT IGNORE INTO students (student_id, name, roll_no, email, department_id, semester) VALUES 
    (1, 'Alice Johnson', 'CS001', 'alice@student.com', 1, 'Spring 2024'),
    (2, 'Bob Martin', 'CS002', 'bob@student.com', 1, 'Spring 2024'),
    (3, 'Carol White', 'CS003', 'carol@student.com', 1, 'Spring 2024'),
    (4, 'David Brown', 'CS004', 'david@student.com', 1, 'Spring 2024'),
    (5, 'Eva Green', 'CS005', 'eva@student.com', 1, 'Spring 2024'),
    (6, 'Frank Miller', 'CS006', 'frank@student.com', 1, 'Spring 2024'),
    (7, 'Grace Lee', 'CS007', 'grace@student.com', 1, 'Spring 2024'),
    (8, 'Henry Davis', 'CS008', 'henry@student.com', 1, 'Spring 2024')");
